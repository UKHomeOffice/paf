...
module.exports = superclass => class extends superclass {
  configure(req, res, next) {
    if (req.sessionModel.get('crime-location-address-line1') ||
    ...
    if (req.sessionModel.get('crime-another-location-address-line1')
      ...
      || req.sessionModel.get('crime-another-location-address-county')) {
      let crimeAnotherAddress = [];
      crimeAnotherAddress.push(req.sessionModel.get('crime-another-location-address-line1'),
        req.sessionModel.get('crime-another-location-address-line2'),
        req.sessionModel.get('crime-another-location-address-town'),
        req.sessionModel.get('crime-another-location-address-county'));
      crimeAnotherAddress = crimeAnotherAddress.filter(str => str !== '');
      req.sessionModel.set('crime-another-location-address',
        crimeAnotherAddress.join(', '));
    } else {
      req.sessionModel.unset('crime-another-location-address');
    }

    if (req.sessionModel.get('report-person-location-uk-address-line1')
    ...
    if (req.sessionModel.get('report-person-location-outside-uk-address-line1')
    ...
    if (req.sessionModel.get('report-person-occupation-company-address-line1')
    ...
    if (req.sessionModel.get('report-person-study-address-line1')
    ...
    if (req.sessionModel.get('company-address-line1')
