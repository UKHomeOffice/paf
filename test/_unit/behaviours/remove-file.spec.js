...
const Behaviour = require('../../../apps/paf/behaviours/remove-file');

describe("apps/paf 'remove-file' behaviour should ", () => {
  ...
  describe("The 'configure' method ", () => {
    ...
    it('should remove an file if an ID is passed to it', () => {
    ...
    it('should redirect if an file is removed', () => {
      req.sessionModel.set('images', images);
      req.query.delete = images[0].id;
      instance.configure(req, res, next);
